...
<p align="center">
    <a href="https://github.com/X-X-Admin/PC-GAMES-BOT">
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/X-X-Admin/PC-GAMES-BOT)
...
```py
git clone https://github.com/X-X-Admin/PC-GAMES-BOT
cd PC-GAMES-BOT
